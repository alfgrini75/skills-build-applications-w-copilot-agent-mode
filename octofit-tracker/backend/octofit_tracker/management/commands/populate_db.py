...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        Activity.objects.create(user=users[2], type='Swimming', duration=60, date='2025-11-17')
        Activity.objects.create(user=users[3], type='Yoga', duration=50, date='2025-11-16')
